...
drone_fl_model, drone_fl_acc, drone_fl_loss = \
    federated_train(dX_tr, dy_tr, dX_v, dy_v, "Drone", iid=False)

print("\n══ NSL-KDD Dataset ══")
kdd_fl_model, kdd_fl_acc, kdd_fl_loss = \
    federated_train(kX_tr, ky_tr, kX_v, ky_v, "NSL-KDD", iid=False)

print("\n" + "="*60)
print(" EVALUATE FEDERATED MODELS")
print("="*60)
...
fig.suptitle("Federated LSTM (FedAvg, NON-IID clients) Intrusion Detection Results",
...
plt.tight_layout()
plt.savefig("outputs/federated_lstm_results_noniid.png", dpi=150, bbox_inches='tight')
print("  Saved → outputs/federated_lstm_results_noniid.png")
plt.close()

print("\n" + "="*60)
print("  FEDERATED LSTM TRAINING COMPLETE")
print("  See phase3_comparison.py to compare with Phase 1 results.")
print("="*60)

drone_fl_model.save("outputs/drone_lstm_federated_noniid.keras")
kdd_fl_model.save("outputs/kdd_lstm_federated_noniid.keras")
