...
drone_prox_model.save("outputs/drone_lstm_fedprox.keras")
kdd_prox_model.save("outputs/kdd_lstm_fedprox.keras")
...
res_df.to_csv("outputs/fedprox_results.csv", index=False)
print("\nSaved outputs/fedprox_results.csv")
print(res_df.to_string(index=False))
fig, axes = plt.subplots(3, 2, figsize=(14, 14))
fig.suptitle("Federated LSTM (FedProx)Intrusion Detection Results", fontsize=14, fontweight='bold')
...
plt.tight_layout()
plt.savefig("outputs/fedprox_results.png", dpi=150, bbox_inches='tight')
print("Saved outputs/fedprox_results.png")
plt.close()
